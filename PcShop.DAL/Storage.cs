...
namespace PcShop.DAL
{
    ...
    {
        private readonly IList<Guid> EvaluationGuids = new List<Guid> // 50
        {
        ...
        private void SeedEvaluations()
        {
            ...
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[5],
                TextEvaluation = "Don't recommend",
                PercentEvaluation = 30,
                ProductId = ProductGuids[3]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[6],
                TextEvaluation = "Don't recommend",
                PercentEvaluation = 30,
                ProductId = ProductGuids[5]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[7],
                TextEvaluation = "Don't recommend",
                PercentEvaluation = 0,
                ProductId = ProductGuids[2]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[8],
                TextEvaluation = "Don't recommend",
                PercentEvaluation = 0,
                ProductId = ProductGuids[7]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[9],
                TextEvaluation = "Don't recommend",
                PercentEvaluation = 0,
                ProductId = ProductGuids[7]
            });
            ...
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[10],
                TextEvaluation = "The best PC",
                PercentEvaluation = 100,
                ProductId = ProductGuids[8]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[11],
                TextEvaluation = "Good",
                PercentEvaluation = 80,
                ProductId = ProductGuids[8]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[12],
                TextEvaluation = "Recommend",
                PercentEvaluation = 80,
                ProductId = ProductGuids[9]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[13],
                TextEvaluation = "Good",
                PercentEvaluation = 80,
                ProductId = ProductGuids[9]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[14],
                TextEvaluation = "Quality for reasonable money, I am satisfied",
                PercentEvaluation = 80,
                ProductId = ProductGuids[10]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[15],
            ...
            Evaluations.Add(new EvaluationEntity
            {
                ...
                ProductId = ProductGuids[11]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[17],
                TextEvaluation = "Good",
                PercentEvaluation = 90,
                ProductId = ProductGuids[11]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[18],
                TextEvaluation = "The best PC",
                PercentEvaluation = 100,
                ProductId = ProductGuids[12]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[19],
                TextEvaluation = "Quality for reasonable money, I am satisfied",
                PercentEvaluation = 90,
                ProductId = ProductGuids[12]
            });
            ...
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[23],
                TextEvaluation = "Recommend",
                PercentEvaluation = 80,
                ProductId = ProductGuids[18]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[24],
                TextEvaluation = "Good",
                PercentEvaluation = 60,
                ProductId = ProductGuids[18]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[25],
                TextEvaluation = "Quality for reasonable money, I am satisfied",
                PercentEvaluation = 100,
                ProductId = ProductGuids[19]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[26],
                TextEvaluation = "It's a good laptop",
                PercentEvaluation = 90,
                ProductId = ProductGuids[20]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[27],
            ...
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[32],
                TextEvaluation = "The best PC",
                PercentEvaluation = 100,
                ProductId = ProductGuids[22]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[33],
                TextEvaluation = "It's a good laptop",
                PercentEvaluation = 100,
                ProductId = ProductGuids[23]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[34],
            ...
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[35],
                TextEvaluation = "Suitable product configuration to suit my needs. I have it for a few days, it is still early for the reliability evaluation, but so far I am satisfied.",
                PercentEvaluation = 80,
                ProductId = ProductGuids[24]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[36],
                TextEvaluation = "Good",
                PercentEvaluation = 60,
                ProductId = ProductGuids[25]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[37],
                TextEvaluation = "Recommend",
                PercentEvaluation = 80,
                ProductId = ProductGuids[25]
            });
            ...
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[39],
                TextEvaluation = "very good",
                PercentEvaluation = 100,
                ProductId = ProductGuids[27]
            });

            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[40],
                TextEvaluation = "Suitable product configuration to suit my needs. I have it for a few days, it is still early for the reliability evaluation, but so far I am satisfied.",
                PercentEvaluation = 70,
                ProductId = ProductGuids[27]
            });
            ...
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[42],
                TextEvaluation = "Meets my requirements",
                PercentEvaluation = 100,
                ProductId = ProductGuids[29]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[43],
                TextEvaluation = "The best PC",
                PercentEvaluation = 100,
                ProductId = ProductGuids[29]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[44],
                TextEvaluation = "I have been using the purchased computer for 14 days and I am satisfied.",
                PercentEvaluation = 80,
                ProductId = ProductGuids[30]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[45],
                TextEvaluation = "The best PC",
                PercentEvaluation = 100,
                ProductId = ProductGuids[30]
            });
            ...
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[47],
                TextEvaluation = "Overall satisfaction, but time will show quality ...",
                PercentEvaluation = 80,
                ProductId = ProductGuids[31]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[48],
                TextEvaluation = "Absolute garbage",
                PercentEvaluation = 0,
                ProductId = ProductGuids[32]
            });
            Evaluations.Add(new EvaluationEntity
            {
                Id = EvaluationGuids[49],
                TextEvaluation = "Recommend",
                PercentEvaluation = 80,
                ProductId = ProductGuids[32]
            });
        ...
        private void SeedProduct()
        {
            Product.Add(new ProductEntity
            {
                ...
                CountInStock = 2,
                Photo = "default.jpg",
                ManufacturerId = ManufacturerGuids[3],
                CategoryId = CategoryGuids[2],
            ...
            Product.Add(new ProductEntity
            {
                ...
                CountInStock = 5,
                Photo = "default.jpg",
                ManufacturerId = ManufacturerGuids[6],
                CategoryId = CategoryGuids[2],
            });
            Product.Add(new ProductEntity
            {
                ...
                CountInStock = 14,
                Photo = "default.jpg",
                ManufacturerId = ManufacturerGuids[4],
                CategoryId = CategoryGuids[2],
            });
            Product.Add(new ProductEntity
            {
            ...
            Product.Add(new ProductEntity
            {
                ...
                CountInStock = 3,
                Photo = "default.jpg",
                ManufacturerId = ManufacturerGuids[7],
                CategoryId = CategoryGuids[0],
            });
            Product.Add(new ProductEntity
            {
            ...
            Product.Add(new ProductEntity
            {
                ...
                CountInStock = 5,
                Photo = "default.jpg",
                ManufacturerId = ManufacturerGuids[8],
                CategoryId = CategoryGuids[1],
            });
            ...
            Product.Add(new ProductEntity
            {
                ...
                CountInStock = 5,
                Photo = "default.jpg",
                ManufacturerId = ManufacturerGuids[2],
                CategoryId = CategoryGuids[0],
            });
            Product.Add(new ProductEntity
            {
