...
namespace PcShop.Api.Tests
{
    ...
    public class EvalutaionControllerTests : IClassFixture<WebApplicationFactory<Startup>>
    {
        private HttpClient _client;

        public EvalutaionControllerTests(WebApplicationFactory<Startup> fixture)
        {
        ...
        public void HelloTest()
        {
            ...
            Debug.Print("Hello test - EvalutaionController");
        }
